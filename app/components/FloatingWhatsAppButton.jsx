...
export default function FloatingWhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[70] inline-flex h-15 w-15 items-center justify-center rounded-full border border-white/10 bg-gradient-to-br from-[#25D366] via-[#1ebe5b] to-[#128C7E] text-white shadow-[0_18px_45px_rgba(37,211,102,0.45)] transition-transform duration-300 hover:scale-105"
    >
